...
function MessageHandler(server,sin_addr,msg) {
//	console.log("msg:" + msg);
	...
	switch (data[0]) {
		...
		//id,tank_id,ws,camp,props
			roomManager.newRoom(SERVER_CONST.ROOM_NUM).addSock(new SOCK(server,sin_addr,data[1],data[3],data[2],data[4]))
			break;
